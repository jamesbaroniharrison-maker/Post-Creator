"""Unified ingestion: turns whatever she sends into the same 'raw notes' text the
...
from wpa_content_engine.capture.caption import caption_photo
from wpa_content_engine.capture.transcribe import transcribe_audio
