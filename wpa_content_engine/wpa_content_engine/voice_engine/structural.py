"""Structural stats: the shape of her posts, independent of what words she picks."""
...
def compute_structural_stats(texts: list[str]) -> dict:
    """Return averages/rates describing how she structures a post, across the whole corpus."""
    if not texts:
        return {}
