...
Usage (from the wpa_content_engine/ app directory, with the venv active):
    python -m wpa_content_engine.email_engine.run --job reminder
    python -m wpa_content_engine.email_engine.run --job digest
    python -m wpa_content_engine.email_engine.run --job reminder --force
"""

import argparse

from wpa_content_engine.email_engine.digest import run_weekly_digest
from wpa_content_engine.email_engine.reminder import run_weekly_reminder
