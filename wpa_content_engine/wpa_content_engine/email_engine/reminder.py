...
from wpa_content_engine.models import EmailSettings, JobRun, Post
from wpa_content_engine.scheduling import current_week_start
...
NUDGE_SUBJECT = "Your personal post is already in - WPA Content Engine"
NUDGE_DRAFTED_BODY = """Hi Ben,
...
# She's never told which one to use - these are just there to make "nothing comes to
# mind" less likely to be the reason a week goes by without a personal post.
PROMPT_POOL = [
    "A client moment that's stuck with you this week",
    "Something that didn't go to plan, and what you took from it",
    "A small win worth a mention, even a quiet one",
    "Advice you'd give someone just starting out in your role",
    "What your day-to-day actually looks like behind the scenes",
    "Something outside work that's been on your mind",
    "A lesson a colleague or mentor passed on to you",
