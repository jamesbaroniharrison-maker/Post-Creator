...
Same hourly-trigger-but-internally-gated pattern as reminder.py - both day and time are
...
from wpa_content_engine.scheduling import allocate_accepted_posts, current_week_label
