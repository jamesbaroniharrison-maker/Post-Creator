...
title WPA Content Engine - Starting...
cd /d "%~dp0wpa_content_engine"

echo ================================================================
echo   WPA Content Engine
echo ================================================================
echo.
...
start "WPA Content Engine - SERVER (leave this open while you work)" cmd /k "call ..\venv\Scripts\activate.bat && reflex run"
...
echo.
echo If that window shows a wall of red text, take a screenshot and
echo send it to James.
echo.
pause
exit /b 1
